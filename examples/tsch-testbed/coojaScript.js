...
var enableAttenuation = 0;
var timeSlice = 15 * 60 * 1000; //15 min in ms
var linkDampingFactor = 0.1;
var startStep = 2;
var failingNodes = 3;
var step = startStep;
...
randomSeedString = time + "\tID:1\t" + "COOJA: Random seed: " + sim.getRandomSeed() + "\n";
log.log(randomSeedString);
...
//if (1) 
{
	...
	log.append(logFileName, randomSeedString);
