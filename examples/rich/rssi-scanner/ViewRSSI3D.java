 ...
 * ---------------------------------------------------
 * Note: run the rssi-scanner on a JN5168 node connected to USB
 * then start with
...
public class ViewRSSI3D extends JPanel {
  ...
  public static int MAX_VALUES = MAX_FREQUENCY - MIN_FREQUENCY + 1; // Number of channel of 1 MHz sampled
